      ...
      <div ref={featuresRef} className="container mx-auto px-4 reveal">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            How <span className="text-gradient <h1 class=\"text-white font-modak text-4xl\">LoSpace</h1>\n">LoSpace</span> Works
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => <div key={index} className="p-6 rounded-2xl bg-background hover-scale shadow-lg transition-all duration-300 hover:shadow-xl">
